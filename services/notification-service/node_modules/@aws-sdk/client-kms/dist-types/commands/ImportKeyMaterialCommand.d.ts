...
declare const ImportKeyMaterialCommand_base: {
    new (input: ImportKeyMaterialCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyMaterialCommandInput, ImportKeyMaterialCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportKeyMaterialCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyMaterialCommandInput, ImportKeyMaterialCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
