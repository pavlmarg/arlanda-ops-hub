...
declare const GetKeyPolicyCommand_base: {
    new (input: GetKeyPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetKeyPolicyCommandInput, GetKeyPolicyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetKeyPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetKeyPolicyCommandInput, GetKeyPolicyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
