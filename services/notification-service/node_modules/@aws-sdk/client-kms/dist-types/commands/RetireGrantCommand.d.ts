...
declare const RetireGrantCommand_base: {
    new (input: RetireGrantCommandInput): import("@smithy/core/client").CommandImpl<RetireGrantCommandInput, RetireGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RetireGrantCommandInput]): import("@smithy/core/client").CommandImpl<RetireGrantCommandInput, RetireGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
