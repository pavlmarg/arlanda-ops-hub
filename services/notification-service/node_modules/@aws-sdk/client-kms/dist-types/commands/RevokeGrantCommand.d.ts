...
declare const RevokeGrantCommand_base: {
    new (input: RevokeGrantCommandInput): import("@smithy/core/client").CommandImpl<RevokeGrantCommandInput, RevokeGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RevokeGrantCommandInput): import("@smithy/core/client").CommandImpl<RevokeGrantCommandInput, RevokeGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
