...
declare const GetParametersForImportCommand_base: {
    new (input: GetParametersForImportCommandInput): import("@smithy/core/client").CommandImpl<GetParametersForImportCommandInput, GetParametersForImportCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetParametersForImportCommandInput): import("@smithy/core/client").CommandImpl<GetParametersForImportCommandInput, GetParametersForImportCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
