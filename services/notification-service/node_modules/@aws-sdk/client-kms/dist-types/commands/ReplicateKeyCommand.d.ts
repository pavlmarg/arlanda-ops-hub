...
declare const ReplicateKeyCommand_base: {
    new (input: ReplicateKeyCommandInput): import("@smithy/core/client").CommandImpl<ReplicateKeyCommandInput, ReplicateKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplicateKeyCommandInput): import("@smithy/core/client").CommandImpl<ReplicateKeyCommandInput, ReplicateKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
