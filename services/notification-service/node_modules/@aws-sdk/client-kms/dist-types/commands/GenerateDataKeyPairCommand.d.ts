...
declare const GenerateDataKeyPairCommand_base: {
    new (input: GenerateDataKeyPairCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyPairCommandInput, GenerateDataKeyPairCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateDataKeyPairCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyPairCommandInput, GenerateDataKeyPairCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
