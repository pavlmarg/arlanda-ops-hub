...
declare const DeleteCustomKeyStoreCommand_base: {
    new (input: DeleteCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomKeyStoreCommandInput, DeleteCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomKeyStoreCommandInput, DeleteCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
