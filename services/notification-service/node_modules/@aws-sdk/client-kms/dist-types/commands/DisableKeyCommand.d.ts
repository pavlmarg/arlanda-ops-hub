...
declare const DisableKeyCommand_base: {
    new (input: DisableKeyCommandInput): import("@smithy/core/client").CommandImpl<DisableKeyCommandInput, DisableKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableKeyCommandInput): import("@smithy/core/client").CommandImpl<DisableKeyCommandInput, DisableKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
