...
declare const ListKeyRotationsCommand_base: {
    new (input: ListKeyRotationsCommandInput): import("@smithy/core/client").CommandImpl<ListKeyRotationsCommandInput, ListKeyRotationsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListKeyRotationsCommandInput): import("@smithy/core/client").CommandImpl<ListKeyRotationsCommandInput, ListKeyRotationsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
