...
declare const DecryptCommand_base: {
    new (input: DecryptCommandInput): import("@smithy/core/client").CommandImpl<DecryptCommandInput, DecryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DecryptCommandInput]): import("@smithy/core/client").CommandImpl<DecryptCommandInput, DecryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
