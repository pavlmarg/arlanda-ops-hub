...
declare const GenerateDataKeyCommand_base: {
    new (input: GenerateDataKeyCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyCommandInput, GenerateDataKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateDataKeyCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyCommandInput, GenerateDataKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
