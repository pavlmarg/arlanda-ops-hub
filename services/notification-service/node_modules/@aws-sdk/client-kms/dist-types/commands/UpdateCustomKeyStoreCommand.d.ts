...
declare const UpdateCustomKeyStoreCommand_base: {
    new (input: UpdateCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomKeyStoreCommandInput, UpdateCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomKeyStoreCommandInput, UpdateCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
