...
declare const ListResourceTagsCommand_base: {
    new (input: ListResourceTagsCommandInput): import("@smithy/core/client").CommandImpl<ListResourceTagsCommandInput, ListResourceTagsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResourceTagsCommandInput): import("@smithy/core/client").CommandImpl<ListResourceTagsCommandInput, ListResourceTagsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
