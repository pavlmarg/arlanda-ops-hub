...
declare const DisableKeyRotationCommand_base: {
    new (input: DisableKeyRotationCommandInput): import("@smithy/core/client").CommandImpl<DisableKeyRotationCommandInput, DisableKeyRotationCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableKeyRotationCommandInput): import("@smithy/core/client").CommandImpl<DisableKeyRotationCommandInput, DisableKeyRotationCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
