...
declare const CancelKeyDeletionCommand_base: {
    new (input: CancelKeyDeletionCommandInput): import("@smithy/core/client").CommandImpl<CancelKeyDeletionCommandInput, CancelKeyDeletionCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelKeyDeletionCommandInput): import("@smithy/core/client").CommandImpl<CancelKeyDeletionCommandInput, CancelKeyDeletionCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
