...
declare const ListRetirableGrantsCommand_base: {
    new (input: ListRetirableGrantsCommandInput): import("@smithy/core/client").CommandImpl<ListRetirableGrantsCommandInput, ListRetirableGrantsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRetirableGrantsCommandInput]): import("@smithy/core/client").CommandImpl<ListRetirableGrantsCommandInput, ListRetirableGrantsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
