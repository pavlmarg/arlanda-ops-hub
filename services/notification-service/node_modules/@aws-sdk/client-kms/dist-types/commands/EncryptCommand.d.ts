...
declare const EncryptCommand_base: {
    new (input: EncryptCommandInput): import("@smithy/core/client").CommandImpl<EncryptCommandInput, EncryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EncryptCommandInput): import("@smithy/core/client").CommandImpl<EncryptCommandInput, EncryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
