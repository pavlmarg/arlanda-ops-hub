...
declare const UpdateKeyDescriptionCommand_base: {
    new (input: UpdateKeyDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateKeyDescriptionCommandInput, UpdateKeyDescriptionCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateKeyDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateKeyDescriptionCommandInput, UpdateKeyDescriptionCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
