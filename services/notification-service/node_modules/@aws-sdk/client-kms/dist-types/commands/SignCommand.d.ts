...
declare const SignCommand_base: {
    new (input: SignCommandInput): import("@smithy/core/client").CommandImpl<SignCommandInput, SignCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SignCommandInput): import("@smithy/core/client").CommandImpl<SignCommandInput, SignCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
