...
declare const DeriveSharedSecretCommand_base: {
    new (input: DeriveSharedSecretCommandInput): import("@smithy/core/client").CommandImpl<DeriveSharedSecretCommandInput, DeriveSharedSecretCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeriveSharedSecretCommandInput): import("@smithy/core/client").CommandImpl<DeriveSharedSecretCommandInput, DeriveSharedSecretCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
