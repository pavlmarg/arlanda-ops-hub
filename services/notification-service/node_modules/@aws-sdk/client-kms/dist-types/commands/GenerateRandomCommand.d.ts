...
declare const GenerateRandomCommand_base: {
    new (input: GenerateRandomCommandInput): import("@smithy/core/client").CommandImpl<GenerateRandomCommandInput, GenerateRandomCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GenerateRandomCommandInput]): import("@smithy/core/client").CommandImpl<GenerateRandomCommandInput, GenerateRandomCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
