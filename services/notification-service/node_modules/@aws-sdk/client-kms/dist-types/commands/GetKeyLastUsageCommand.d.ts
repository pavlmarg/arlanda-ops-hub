...
declare const GetKeyLastUsageCommand_base: {
    new (input: GetKeyLastUsageCommandInput): import("@smithy/core/client").CommandImpl<GetKeyLastUsageCommandInput, GetKeyLastUsageCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetKeyLastUsageCommandInput): import("@smithy/core/client").CommandImpl<GetKeyLastUsageCommandInput, GetKeyLastUsageCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
