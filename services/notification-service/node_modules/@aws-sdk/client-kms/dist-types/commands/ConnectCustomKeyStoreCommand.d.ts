...
declare const ConnectCustomKeyStoreCommand_base: {
    new (input: ConnectCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<ConnectCustomKeyStoreCommandInput, ConnectCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConnectCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<ConnectCustomKeyStoreCommandInput, ConnectCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
