...
declare const ListKeyPoliciesCommand_base: {
    new (input: ListKeyPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListKeyPoliciesCommandInput, ListKeyPoliciesCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListKeyPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListKeyPoliciesCommandInput, ListKeyPoliciesCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
