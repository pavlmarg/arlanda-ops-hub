...
declare const DisconnectCustomKeyStoreCommand_base: {
    new (input: DisconnectCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<DisconnectCustomKeyStoreCommandInput, DisconnectCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisconnectCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<DisconnectCustomKeyStoreCommandInput, DisconnectCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
