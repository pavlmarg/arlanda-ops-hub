...
declare const GenerateMacCommand_base: {
    new (input: GenerateMacCommandInput): import("@smithy/core/client").CommandImpl<GenerateMacCommandInput, GenerateMacCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateMacCommandInput): import("@smithy/core/client").CommandImpl<GenerateMacCommandInput, GenerateMacCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
