...
declare const EnableKeyRotationCommand_base: {
    new (input: EnableKeyRotationCommandInput): import("@smithy/core/client").CommandImpl<EnableKeyRotationCommandInput, EnableKeyRotationCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableKeyRotationCommandInput): import("@smithy/core/client").CommandImpl<EnableKeyRotationCommandInput, EnableKeyRotationCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
