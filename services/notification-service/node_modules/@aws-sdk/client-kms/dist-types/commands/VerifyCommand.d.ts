...
declare const VerifyCommand_base: {
    new (input: VerifyCommandInput): import("@smithy/core/client").CommandImpl<VerifyCommandInput, VerifyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifyCommandInput): import("@smithy/core/client").CommandImpl<VerifyCommandInput, VerifyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
