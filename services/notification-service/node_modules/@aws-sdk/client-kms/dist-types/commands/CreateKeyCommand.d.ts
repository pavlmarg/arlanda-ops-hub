...
declare const CreateKeyCommand_base: {
    new (input: CreateKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyCommandInput, CreateKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateKeyCommandInput]): import("@smithy/core/client").CommandImpl<CreateKeyCommandInput, CreateKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
