...
declare const EnableKeyCommand_base: {
    new (input: EnableKeyCommandInput): import("@smithy/core/client").CommandImpl<EnableKeyCommandInput, EnableKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableKeyCommandInput): import("@smithy/core/client").CommandImpl<EnableKeyCommandInput, EnableKeyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
