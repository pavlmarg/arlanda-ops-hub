...
declare const PutKeyPolicyCommand_base: {
    new (input: PutKeyPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutKeyPolicyCommandInput, PutKeyPolicyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutKeyPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutKeyPolicyCommandInput, PutKeyPolicyCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
