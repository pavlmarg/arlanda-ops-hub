...
declare const CreateCustomKeyStoreCommand_base: {
    new (input: CreateCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomKeyStoreCommandInput, CreateCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCustomKeyStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomKeyStoreCommandInput, CreateCustomKeyStoreCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
