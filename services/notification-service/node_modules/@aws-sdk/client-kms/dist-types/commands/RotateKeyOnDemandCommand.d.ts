...
declare const RotateKeyOnDemandCommand_base: {
    new (input: RotateKeyOnDemandCommandInput): import("@smithy/core/client").CommandImpl<RotateKeyOnDemandCommandInput, RotateKeyOnDemandCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RotateKeyOnDemandCommandInput): import("@smithy/core/client").CommandImpl<RotateKeyOnDemandCommandInput, RotateKeyOnDemandCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
