...
declare const CreateGrantCommand_base: {
    new (input: CreateGrantCommandInput): import("@smithy/core/client").CommandImpl<CreateGrantCommandInput, CreateGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGrantCommandInput): import("@smithy/core/client").CommandImpl<CreateGrantCommandInput, CreateGrantCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
