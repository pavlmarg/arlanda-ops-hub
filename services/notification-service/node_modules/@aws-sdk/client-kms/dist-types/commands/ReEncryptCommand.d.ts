...
declare const ReEncryptCommand_base: {
    new (input: ReEncryptCommandInput): import("@smithy/core/client").CommandImpl<ReEncryptCommandInput, ReEncryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReEncryptCommandInput): import("@smithy/core/client").CommandImpl<ReEncryptCommandInput, ReEncryptCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
