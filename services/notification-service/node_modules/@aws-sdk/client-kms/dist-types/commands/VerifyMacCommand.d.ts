...
declare const VerifyMacCommand_base: {
    new (input: VerifyMacCommandInput): import("@smithy/core/client").CommandImpl<VerifyMacCommandInput, VerifyMacCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifyMacCommandInput): import("@smithy/core/client").CommandImpl<VerifyMacCommandInput, VerifyMacCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
