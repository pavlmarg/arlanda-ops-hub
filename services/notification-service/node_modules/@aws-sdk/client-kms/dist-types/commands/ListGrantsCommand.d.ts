...
declare const ListGrantsCommand_base: {
    new (input: ListGrantsCommandInput): import("@smithy/core/client").CommandImpl<ListGrantsCommandInput, ListGrantsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGrantsCommandInput): import("@smithy/core/client").CommandImpl<ListGrantsCommandInput, ListGrantsCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
