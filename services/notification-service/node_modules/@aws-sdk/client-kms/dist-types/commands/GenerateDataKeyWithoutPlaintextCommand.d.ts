...
declare const GenerateDataKeyWithoutPlaintextCommand_base: {
    new (input: GenerateDataKeyWithoutPlaintextCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyWithoutPlaintextCommandInput, GenerateDataKeyWithoutPlaintextCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateDataKeyWithoutPlaintextCommandInput): import("@smithy/core/client").CommandImpl<GenerateDataKeyWithoutPlaintextCommandInput, GenerateDataKeyWithoutPlaintextCommandOutput, import("..").KMSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
