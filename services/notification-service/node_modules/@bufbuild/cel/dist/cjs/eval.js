...
exports.setEvalContext = setEvalContext;
exports.getEvalContext = getEvalContext;
exports.withEvalContext = withEvalContext;
exports.getMsgDesc = getMsgDesc;
const contextStack = [];
/**
 * Sets the EvalContext for the current execution scope.
 */
function setEvalContext(context) {
 ...
 */
function withEvalContext(context, next) {
    return {
        id: next.id,
        eval(ctx) {
