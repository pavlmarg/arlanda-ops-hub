 ...
 */
export declare const file_cel_expr_conformance_proto2_test_all_types: GenFile;
/**
 ...
 */
export declare const TestAllTypes_NestedGroupSchema: GenMessage<TestAllTypes_NestedGroup>;
/**
 ...
 */
export declare enum GlobalEnum {
    /**
 ...
 */
export declare const GlobalEnumSchema: GenEnum<GlobalEnum>;
