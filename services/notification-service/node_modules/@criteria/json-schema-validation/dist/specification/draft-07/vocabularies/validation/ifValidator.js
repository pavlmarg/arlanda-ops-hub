...
function ifValidator(schema, schemaPath, context) {
    ...
    var thenValidator = thenSchema !== undefined ? context.validatorForSchema(thenSchema, __spreadArray(__spreadArray([], __read(schemaPath), false), ['/then'], false)) : null;
    var elseSchema = schema['else'];
    var elseValidator = elseSchema !== undefined ? context.validatorForSchema(elseSchema, __spreadArray(__spreadArray([], __read(schemaPath), false), ['/else'], false)) : null;
