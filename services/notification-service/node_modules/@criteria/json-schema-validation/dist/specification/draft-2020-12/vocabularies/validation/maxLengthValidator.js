...
function maxLengthValidator(schema, schemaPath, context) {
    ...
    return function (instance, instanceLocation, annotationResults) {
        ...
        if (charactersCount <= maxLength) {
            return { valid: true, schemaLocation: schemaLocation, schemaKeyword: 'maxLength', instanceLocation: instanceLocation };
        }
        else {
            if (outputFormat === 'flag') {
                ...
                return {
                    ...
                    message: maxLength === 1
                        ? "should have up to 1 character but has ".concat(charactersCount, " instead")
                        : "should have up to ".concat(maxLength, " characters but has ").concat(charactersCount, " instead")
                };
            }
        }
    };
