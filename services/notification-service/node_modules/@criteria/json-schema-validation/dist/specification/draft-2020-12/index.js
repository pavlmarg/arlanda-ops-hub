...
exports.metaSchemaID = draft_2020_12_1.metaSchemaID;
var jsonValidator_1 = require("../../validation/jsonValidator");
function jsonValidator(schema, options) {
    return (0, jsonValidator_1.jsonValidator)(schema, __assign(__assign({}, options), { defaultMetaSchemaID: draft_2020_12_1.metaSchemaID }));
}
...
function validateJSON(instance, schema, options) {
    return (0, jsonValidator_1.validateJSON)(instance, schema, __assign(__assign({}, options), { defaultMetaSchemaID: draft_2020_12_1.metaSchemaID }));
}
...
function isJSONValid(instance, schema, options) {
    return (0, jsonValidator_1.isJSONValid)(instance, schema, __assign(__assign({}, options), { defaultMetaSchemaID: draft_2020_12_1.metaSchemaID }));
}
