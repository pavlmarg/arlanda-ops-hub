...
function reduceAnnotationResults(lhs, rhs) {
    var _a, _b, _c;
    var properties = rhs.properties, patternProperties = rhs.patternProperties, additionalProperties = rhs.additionalProperties, items = rhs.items, additionalItems = rhs.additionalItems, rest = __rest(rhs, ["properties", "patternProperties", "additionalProperties", "items", "additionalItems"]);
