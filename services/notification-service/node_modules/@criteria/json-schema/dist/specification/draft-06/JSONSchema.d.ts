 ...
 */
export type JSONSchema<ReferenceType extends string | object = string> = JSONSchemaBooleanSchema | JSONSchemaObject<ReferenceType>;
/**
 * JSON Schema Draft 06
 *
 * @see https://datatracker.ietf.org/doc/html/draft-wright-json-schema-01
...
export interface JSONSchemaObject<ReferenceType extends string | object = string> {
    ...
    required?: string[];
    properties?: {
        [key: string]: JSONSchema<ReferenceType>;
    };
    patternProperties?: {
        [key: string]: JSONSchema<ReferenceType>;
    };
    ...
    dependencies?: {
        [key: string]: JSONSchema<ReferenceType> | string[];
    };
