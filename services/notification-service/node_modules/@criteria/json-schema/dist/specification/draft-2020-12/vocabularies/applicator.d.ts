 ...
 */
export type JSONSchemaApplicatorVocabulary<AdditionalVocabularies extends object, ReferenceType extends string | object> = {
    ...
    dependentSchemas?: {
        [key: string]: JSONSchema<AdditionalVocabularies, ReferenceType>;
    };
    prefixItems?: [
