...
function fromNumber(value) {
    if (Number.isNaN(value) || value % 1 !== 0) {
        throw new invalid_arguments_exception_1.InvalidArgumentsException('cannot convert non-integer value');
    }
    if (value < 0) {
        throw new invalid_arguments_exception_1.InvalidArgumentsException('cannot convert negative number');
    }
    if (value > Number.MAX_SAFE_INTEGER) {
        throw new invalid_arguments_exception_1.InvalidArgumentsException('cannot convert number larger than ' + Number.MAX_SAFE_INTEGER);
    }
...
function fromHex(hex) {
    if (hex.length % 2 != 0) {
        throw new invalid_arguments_exception_1.InvalidArgumentsException('Hex string length must be multiple of 2');
    }
