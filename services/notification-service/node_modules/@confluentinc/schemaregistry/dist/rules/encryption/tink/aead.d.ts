...
export declare abstract class Aead {
     ...
     *
     */
    abstract encrypt(plaintext: Uint8Array<ArrayBuffer>, opt_associatedData?: Uint8Array<ArrayBuffer> | null): Promise<Uint8Array<ArrayBuffer>>;
    /**
     ...
     */
    abstract decrypt(ciphertext: Uint8Array<ArrayBuffer>, opt_associatedData?: Uint8Array<ArrayBuffer> | null): Promise<Uint8Array<ArrayBuffer>>;
}
