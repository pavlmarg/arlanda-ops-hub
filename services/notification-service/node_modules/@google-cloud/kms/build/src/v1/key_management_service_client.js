...
class KeyManagementServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listRetiredResources: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'retiredResources'),
        };
        ...
        const deleteCryptoKeyResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteCryptoKeyMetadata = protoFilesRoot.lookup('.google.cloud.kms.v1.DeleteCryptoKeyMetadata');
        const deleteCryptoKeyVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteCryptoKeyVersionMetadata = protoFilesRoot.lookup('.google.cloud.kms.v1.DeleteCryptoKeyVersionMetadata');
        this.descriptors.longrunning = {
            deleteCryptoKey: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteCryptoKeyResponse.decode.bind(deleteCryptoKeyResponse), deleteCryptoKeyMetadata.decode.bind(deleteCryptoKeyMetadata)),
            deleteCryptoKeyVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteCryptoKeyVersionResponse.decode.bind(deleteCryptoKeyVersionResponse), deleteCryptoKeyVersionMetadata.decode.bind(deleteCryptoKeyVersionMetadata)),
        };
    ...
    getRetiredResource(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .getRetiredResource(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getRetiredResource response %j', response);
            return [response, options, rawResponse];
        })
    ...
    decapsulate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .decapsulate(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('decapsulate response %j', response);
            return [response, options, rawResponse];
        })
    ...
    deleteCryptoKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        return this.innerApiCalls
            .deleteCryptoKey(request, options, wrappedCallback)
     ...
     */
    async checkDeleteCryptoKeyProgress(name) {
    ...
    deleteCryptoKeyVersion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        return this.innerApiCalls
            .deleteCryptoKeyVersion(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('deleteCryptoKeyVersion response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkDeleteCryptoKeyVersionProgress(name) {
    ...
    listRetiredResources(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listRetiredResourcesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listRetiredResources.createStream(this.innerApiCalls.listRetiredResources, request, callSettings);
    }
    /**
     ...
     */
    listRetiredResourcesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listRetiredResources.asyncIterate(this.innerApiCalls['listRetiredResources'], request, callSettings);
    }
    /**
