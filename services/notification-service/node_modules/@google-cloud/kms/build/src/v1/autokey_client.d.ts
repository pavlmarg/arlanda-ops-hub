...
export declare class AutokeyClient {
    ...
    listKeyHandles(request: protos.google.cloud.kms.v1.IListKeyHandlesRequest, options: CallOptions, callback: PaginationCallback<protos.google.cloud.kms.v1.IListKeyHandlesRequest, protos.google.cloud.kms.v1.IListKeyHandlesResponse | null | undefined, protos.google.cloud.kms.v1.IKeyHandle>): void;
    listKeyHandles(request: protos.google.cloud.kms.v1.IListKeyHandlesRequest, callback: PaginationCallback<protos.google.cloud.kms.v1.IListKeyHandlesRequest, protos.google.cloud.kms.v1.IListKeyHandlesResponse | null | undefined, protos.google.cloud.kms.v1.IKeyHandle>): void;
    /**
     ...
     *   for more details and examples.
     */
    listKeyHandlesStream(request?: protos.google.cloud.kms.v1.IListKeyHandlesRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listKeyHandlesAsync(request?: protos.google.cloud.kms.v1.IListKeyHandlesRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.kms.v1.IKeyHandle>;
    /**
