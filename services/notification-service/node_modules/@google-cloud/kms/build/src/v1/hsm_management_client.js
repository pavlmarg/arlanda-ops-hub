...
exports.HsmManagementClient = void 0;
 ...
 */
const gapicConfig = require("./hsm_management_client_config.json");
...
class HsmManagementClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('kms');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            folderAutokeyConfigPathTemplate: new this._gaxModule.PathTemplate('folders/{folder}/autokeyConfig'),
            ...
            projectAutokeyConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/autokeyConfig'),
            ...
            retiredResourcePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/retiredResources/{retired_resource}'),
            singleTenantHsmInstancePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/singleTenantHsmInstances/{single_tenant_hsm_instance}'),
            singleTenantHsmInstanceProposalPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/singleTenantHsmInstances/{single_tenant_hsm_instance}/proposals/{proposal}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listSingleTenantHsmInstances: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'singleTenantHsmInstances'),
            listSingleTenantHsmInstanceProposals: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'singleTenantHsmInstanceProposals'),
        };
        ...
        const createSingleTenantHsmInstanceResponse = protoFilesRoot.lookup('.google.cloud.kms.v1.SingleTenantHsmInstance');
        const createSingleTenantHsmInstanceMetadata = protoFilesRoot.lookup('.google.cloud.kms.v1.CreateSingleTenantHsmInstanceMetadata');
        const createSingleTenantHsmInstanceProposalResponse = protoFilesRoot.lookup('.google.cloud.kms.v1.SingleTenantHsmInstanceProposal');
        const createSingleTenantHsmInstanceProposalMetadata = protoFilesRoot.lookup('.google.cloud.kms.v1.CreateSingleTenantHsmInstanceProposalMetadata');
        const executeSingleTenantHsmInstanceProposalResponse = protoFilesRoot.lookup('.google.cloud.kms.v1.ExecuteSingleTenantHsmInstanceProposalResponse');
        const executeSingleTenantHsmInstanceProposalMetadata = protoFilesRoot.lookup('.google.cloud.kms.v1.ExecuteSingleTenantHsmInstanceProposalMetadata');
        this.descriptors.longrunning = {
            createSingleTenantHsmInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSingleTenantHsmInstanceResponse.decode.bind(createSingleTenantHsmInstanceResponse), createSingleTenantHsmInstanceMetadata.decode.bind(createSingleTenantHsmInstanceMetadata)),
            createSingleTenantHsmInstanceProposal: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSingleTenantHsmInstanceProposalResponse.decode.bind(createSingleTenantHsmInstanceProposalResponse), createSingleTenantHsmInstanceProposalMetadata.decode.bind(createSingleTenantHsmInstanceProposalMetadata)),
            executeSingleTenantHsmInstanceProposal: new this._gaxModule.LongrunningDescriptor(this.operationsClient, executeSingleTenantHsmInstanceProposalResponse.decode.bind(executeSingleTenantHsmInstanceProposalResponse), executeSingleTenantHsmInstanceProposalMetadata.decode.bind(executeSingleTenantHsmInstanceProposalMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.kms.v1.HsmManagement', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.hsmManagementStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.kms.v1.HsmManagement')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.kms.v1.HsmManagement, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of hsmManagementStubMethods) {
            const callPromise = this.hsmManagementStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    getSingleTenantHsmInstance(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    approveSingleTenantHsmInstanceProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getSingleTenantHsmInstanceProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteSingleTenantHsmInstanceProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createSingleTenantHsmInstance(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateSingleTenantHsmInstanceProgress(name) {
    ...
    createSingleTenantHsmInstanceProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateSingleTenantHsmInstanceProposalProgress(name) {
    ...
    executeSingleTenantHsmInstanceProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkExecuteSingleTenantHsmInstanceProposalProgress(name) {
    ...
    listSingleTenantHsmInstances(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSingleTenantHsmInstancesStream(request, options) {
        ...
        return this.descriptors.page.listSingleTenantHsmInstances.createStream(this.innerApiCalls.listSingleTenantHsmInstances, request, callSettings);
    }
    /**
    ...
    listSingleTenantHsmInstancesAsync(request, options) {
        ...
        return this.descriptors.page.listSingleTenantHsmInstances.asyncIterate(this.innerApiCalls['listSingleTenantHsmInstances'], request, callSettings);
    }
    listSingleTenantHsmInstanceProposals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSingleTenantHsmInstanceProposalsStream(request, options) {
        ...
        return this.descriptors.page.listSingleTenantHsmInstanceProposals.createStream(this.innerApiCalls.listSingleTenantHsmInstanceProposals, request, callSettings);
    }
    /**
    ...
    listSingleTenantHsmInstanceProposalsAsync(request, options) {
        ...
        return this.descriptors.page.listSingleTenantHsmInstanceProposals.asyncIterate(this.innerApiCalls['listSingleTenantHsmInstanceProposals'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    folderAutokeyConfigPath(folder) {
     ...
     */
    matchFolderFromFolderAutokeyConfigName(folderAutokeyConfigName) {
     ...
     * @returns {string} Resource name string.
     */
    projectAutokeyConfigPath(project) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectAutokeyConfigName(projectAutokeyConfigName) {
     ...
     * @returns {string} Resource name string.
     */
    retiredResourcePath(project, location, retiredResource) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromRetiredResourceName(retiredResourceName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromRetiredResourceName(retiredResourceName) {
     ...
     */
    matchRetiredResourceFromRetiredResourceName(retiredResourceName) {
...
exports.HsmManagementClient = HsmManagementClient;
//# sourceMappingURL=hsm_management_client.js.map